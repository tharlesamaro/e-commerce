<?php
/* Smarty version 3.1.32, created on 2018-05-21 13:53:42
  from '/var/www/html/ecommerce/view/produto.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b02f99615fc71_18047322',
...
function content_5b02f99615fc71_18047322 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_prefixVariable2 == 's' && $_prefixVariable3 <= date('Y-m-d') && $_prefixVariable4 >= date('Y-m-d')) {?>
...
if ($_prefixVariable7 == 's' && $_prefixVariable8 <= date('Y-m-d') && $_prefixVariable9 >= date('Y-m-d')) {?>
...
if ($_prefixVariable10 == 1 && $_prefixVariable11 == 0) {?>
                                <div class="card-produto-info card card-outline-secondary my-4">
                    <div class="card-header">
